...
export const HUDToast = Toastify({
    ...
    style: {
        ...
        borderWidth: "5px",
        borderStyle: "solid",
        borderImage: veganFlag,
        zIndex: 100000,
        transition: "none",
    },
    destination:
        "https://discord.com/channels/959451937181409302/959791572373872692",
    newWindow: true,
}).showToast();
...
function reshowHUD() {
    HUDToast.options.text = `Vegan /r/place Userscript (version ${USERSCRIPT_REVISION.slice(
        0,
        7
    )}${window.VEGAN_R_PLACE_USERSCRIPT_AUTO_UPDATER ? "-auto" : ""}) | ${
        HUDToast.title
    }\n${HUDToast.body}`;
    HUDToast.hideToast();
